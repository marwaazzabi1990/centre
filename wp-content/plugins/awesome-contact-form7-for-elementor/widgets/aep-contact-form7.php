	   ...
	   if (!function_exists('wpcf7')) {
		...
		$this->add_control(
			...
			[
				...
				'raw' => __('<strong>AEP Contact Form 7</strong> requires to be installed/activated on your site. Please install and activate <strong>Contact Form 7</strong> first.', 'aep'),
